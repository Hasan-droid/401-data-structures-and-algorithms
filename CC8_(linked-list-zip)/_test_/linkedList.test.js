...
describe("LinkedList.js TESTS", () => {
  ...
  it('linkedListZip() succes sinario',()=>{
    // let newlist=new LinkedList();
    ...
    test2.append(3);
    test2.append(2);
    expect(test1.LinkedListZip(test1,test2).toString()).toEqual('1\n1\n4\n3\n6\n2\n')
  });
  it('linkedListZip()  empty list ERROR',()=>{
    //let newlist=new LinkedList();
    let test1=new LinkedList();
    let test2=new LinkedList();
    test2.insert(6);
    ...
    test2.append(1);
    test2.append(13);
    expect(test1.LinkedListZip(test1,test2).toString()).toEqual('6\n9\n2\n1\n13\n')
  });
  it('linkedListZip()  the length not equal ERROR',()=>{
    //let newList = new LinkedList();
    let test1=new LinkedList();
